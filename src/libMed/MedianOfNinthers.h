...
// from a DLL simpler. All files within this DLL are compiled with the MEDIANOFNINTHERS_EXPORTS
// symbol defined on the command line. This symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see
// MEDIANOFNINTHERS_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.
#ifdef MEDIANOFNINTHERS_EXPORTS
#define MEDIANOFNINTHERS_API __declspec(dllexport)
#else
#define MEDIANOFNINTHERS_API __declspec(dllimport)
#endif


//MEDIANOFNINTHERS_API int fnMedianOfNinthers(double* arr, int n, double* med);
